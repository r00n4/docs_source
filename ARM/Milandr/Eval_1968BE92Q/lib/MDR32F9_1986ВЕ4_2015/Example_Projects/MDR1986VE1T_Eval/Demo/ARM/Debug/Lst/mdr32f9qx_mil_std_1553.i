#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_mil_std_1553.c"
...
#line 26 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_mil_std_1553.c"
#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_mil_std_1553.h"
...
#line 35 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_mil_std_1553.h"
...
#line 209 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_mil_std_1553.h"

#line 216 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_mil_std_1553.h"
...
#line 290 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_mil_std_1553.h"
...
#line 27 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_mil_std_1553.c"
...
#line 28 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_mil_std_1553.c"
...
void  MIL_STD_1553_BRGInit(uint32_t MIL_STD_1553_BRG)
{
	...
	tmpreg = ((MDR_RST_CLK_TypeDef *)(0x40020000) )->ETH_CLOCK;

	tmpreg |= ((uint32_t)0x02000000);
	tmpreg &= ~((uint32_t)0x0000FF00);
	tmpreg |= (MIL_STD_1553_BRG << 8);

	 
	((MDR_RST_CLK_TypeDef *)(0x40020000) )->ETH_CLOCK = tmpreg;
}
...
void MIL_STD_1553_Init(MDR_MIL_STD_1553_TypeDef * MIL_STD_1553x, MIL_STD_1553_InitTypeDef * MIL_STD_1553_InitStruct)
{
	...
	tmpreg = (MIL_STD_1553_InitStruct->MIL_STD_1553_RERR << 18)
		   | (MIL_STD_1553_InitStruct->MIL_STD_1553_Mode << 2)
		   | (MIL_STD_1553_InitStruct->MIL_STD_1553_DIV << 11)
		   | (MIL_STD_1553_InitStruct->MIL_STD_1553_RTA << 6)
		   | (MIL_STD_1553_InitStruct->MIL_STD_1553_TRA << 4)
		   | (MIL_STD_1553_InitStruct->MIL_STD_1553_TRB << 5);


	tmpreg |= MIL_STD_1553_InitStruct->MIL_STD_1553_Automatic_Adjustment << 21
		   |  MIL_STD_1553_InitStruct->MIL_STD_1553_Filtration_Flow << 20
		   |  MIL_STD_1553_InitStruct->MIL_STD_1553_Inversion_Signals << 19;
...
void MIL_STD_1553xStructInit(MIL_STD_1553_InitTypeDef * MIL_STD_1553_InitStruct)
{
	...
	MIL_STD_1553_InitStruct->MIL_STD_1553_Mode = ((uint32_t)0x02);
...
void MIL_STD_1553_Cmd(MDR_MIL_STD_1553_TypeDef * MIL_STD_1553x, FunctionalState NewState)
{
	...
	if(NewState == ENABLE){
		...
		MIL_STD_1553x->CONTROL &= ~((uint32_t)0x00000001);
	}
	else{
		 
		MIL_STD_1553x->CONTROL |= ~((uint32_t)0x0000FFFE);
	}
}
...
uint32_t MIL_STD_1553_GetCommandWord(MDR_MIL_STD_1553_TypeDef * MIL_STD_1553x, uint32_t COMMAND_WORDx)
{
	...
	if (COMMAND_WORDx == ((uint32_t)0x00000000)) {
...
void MIL_STD_1553_SetStatusWord(MDR_MIL_STD_1553_TypeDef * MIL_STD_1553x, uint32_t STATUS_WORDx, MIL_STD_1553_StatusWordTypeDef * StatusWord)
{
	...
	if(STATUS_WORDx == ((uint32_t)0x00000000)){
...
void MIL_STD_1553_StartTransmision(MDR_MIL_STD_1553_TypeDef * MIL_STD_1553x)
{
	...
	MIL_STD_1553x->CONTROL |= ((uint32_t)0x00000002);
}
...
void MIL_STD_1553_RERRCmd(MDR_MIL_STD_1553_TypeDef * MIL_STD_1553x, FunctionalState NewState)
{
	...
	if(NewState != DISABLE){
		MIL_STD_1553x->CONTROL |= ((uint32_t)0x00040000);
	}
	else{
		MIL_STD_1553x->CONTROL &= ~((uint32_t)0x00040000);
	}
