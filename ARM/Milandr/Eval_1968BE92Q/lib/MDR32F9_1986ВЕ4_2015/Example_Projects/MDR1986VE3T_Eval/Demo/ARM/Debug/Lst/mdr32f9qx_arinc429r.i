#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_arinc429r.c"
...
#line 26 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_arinc429r.c"
#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_arinc429r.h"
...
#line 35 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_arinc429r.h"
...
typedef struct {
	uint32_t 		ARINC429R_CLK;		
 
	FunctionalState ARINC429R_SD;		
 
	FunctionalState ARINC429R_LB;		
 
	BitStatus 		ARINC429R_SDI1;		
 
	BitStatus 		ARINC429R_SDI2;		
 
	uint32_t 		ARINC429R_DIV;		
...
#line 100 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_arinc429r.h"
...
#line 171 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_arinc429r.h"
...
#line 27 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_arinc429r.c"
...
void ARINC429R_BRG_Init(uint32_t ARINC429R_BRG)
{
	...
	ARINC429Rx = ((MDR_ARINC429R_TypeDef *)(0x400D0000) );
	...
	tmpreg_CONTROL1 &= ~((uint32_t)0xF0000000);
	tmpreg_CONTROL2 &= ~((uint32_t)0x00000007);

	 
	tmpreg_CONTROL1 |= ((ARINC429R_BRG & 0x0F )<< 28);
	tmpreg_CONTROL2 |= (((ARINC429R_BRG & 0x70)>>4) << 0);
...
void ARINC429R_ChannelInit(uint32_t ARINC429R_CHANNELx, ARINC429R_InitChannelTypeDef * ARINC429R_InitChannelStruct)
{
	...
	tmpreg_CONTROL1 = ARINC429Rx->CONTROL1;
	tmpreg_CONTROL1 &= ~(1<<(14 + ARINC429R_CHANNELx));
	tmpreg_CONTROL1 |= ARINC429R_InitChannelStruct->ARINC429R_CLK << (14 + ARINC429R_CHANNELx);
	ARINC429Rx->CONTROL1 = tmpreg_CONTROL1;

	 
	tmpreg_CONTROL2 = ARINC429Rx->CONTROL2;
	tmpreg_CONTROL2 &= ~( (1<<(3 + ARINC429R_CHANNELx))						 |(1<<(17 + ARINC429R_CHANNELx)));

	tmpreg_CONTROL2 |= ( (ARINC429R_InitChannelStruct->ARINC429R_LB << (3 + ARINC429R_CHANNELx))					    |(ARINC429R_InitChannelStruct->ARINC429R_SD << (17 + ARINC429R_CHANNELx)));

	ARINC429Rx->CONTROL2 = tmpreg_CONTROL2;

	 
	tmpreg_CONTROL3 = ARINC429Rx->CONTROL3;
	tmpreg_CONTROL3 &= ~( (1<<(0 +ARINC429R_CHANNELx))						 |(1<<(14 +ARINC429R_CHANNELx)));

	tmpreg_CONTROL3 |= ( (ARINC429R_InitChannelStruct->ARINC429R_SDI1 << (0 +ARINC429R_CHANNELx))						|(ARINC429R_InitChannelStruct->ARINC429R_SDI2 << (14 +ARINC429R_CHANNELx)));
	...
	switch (ARINC429R_CHANNELx){
		...
		case ((uint32_t)0x00000007):
			...
			tmpreg_CONTROL5 &= ~(0xFF<<((ARINC429R_CHANNELx - ((uint32_t)0x00000004))*8));
			tmpreg_CONTROL5 |= ARINC429R_InitChannelStruct->ARINC429R_DIV << ((ARINC429R_CHANNELx - ((uint32_t)0x00000004))*8);
			ARINC429Rx->CONTROL5 = tmpreg_CONTROL5;
			break;

		case ((uint32_t)0x00000008):
		case ((uint32_t)0x00000009):
		case ((uint32_t)0x0000000A):
		case ((uint32_t)0x0000000B):
			tmpreg_CONTROL6 = ARINC429Rx->CONTROL6;
			tmpreg_CONTROL6 &= ~(0xFF<<((ARINC429R_CHANNELx - ((uint32_t)0x00000008))*8));
			tmpreg_CONTROL6 |= ARINC429R_InitChannelStruct->ARINC429R_DIV << ((ARINC429R_CHANNELx - ((uint32_t)0x00000008))*8);
			ARINC429Rx->CONTROL6 = tmpreg_CONTROL6;
			break;
		case ((uint32_t)0x0000000C):
		case ((uint32_t)0x0000000D):
			tmpreg_CONTROL7 = ARINC429Rx->CONTROL7;
			tmpreg_CONTROL7 &= ~(0xFF<<((ARINC429R_CHANNELx - ((uint32_t)0x0000000C))*8));
			tmpreg_CONTROL7 |= ARINC429R_InitChannelStruct->ARINC429R_DIV << ((ARINC429R_CHANNELx - ((uint32_t)0x0000000C))*8);
...
void ARINC429R_ChannelCmd(uint32_t ARINC429R_CHANNELx, FunctionalState NewState)
{
	...
	if(NewState != DISABLE){
		...
		ARINC429Rx->CONTROL1 |= 1<<(0 + ARINC429R_CHANNELx);
	}
	else{
...
#line 343 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_arinc429r.c"
...
FlagStatus ARINC429R_GetFlagStatus(uint32_t ARINC429R_CHANNELx, uint32_t ARINC429R_FLAG)
{
	...
	switch(ARINC429R_FLAG){
		case ((uint32_t)0x0000001):
			bitstatus = (ARINC429Rx->STATUS1 & (1 << (0 + ARINC429R_CHANNELx))) == 0 ? RESET : SET;
			break;
		case ((uint32_t)0x0000000):
			bitstatus = (ARINC429Rx->STATUS1 & (1 << (14 + ARINC429R_CHANNELx))) == 0 ? RESET : SET;
			break;
		case ((uint32_t)0x0000002):
			bitstatus = (ARINC429Rx->STATUS2 & (1 << (14 + ARINC429R_CHANNELx))) == 0 ? RESET : SET;
			break;
		case ((uint32_t)0x0000003):
			bitstatus = (ARINC429Rx->STATUS2 & (1 << (0 + ARINC429R_CHANNELx))) == 0 ? RESET : SET;
			break;
...
#line 519 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_arinc429r.c"
