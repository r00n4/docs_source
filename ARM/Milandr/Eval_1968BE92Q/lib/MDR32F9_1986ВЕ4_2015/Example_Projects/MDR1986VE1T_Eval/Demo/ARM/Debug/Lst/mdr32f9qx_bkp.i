...
#line 159 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_bkp.c"
...
void BKP_RTC_Enable ( FunctionalState NewState )
{
	...
	if(NewState != DISABLE){
		((MDR_BKP_TypeDef *)(0x400D8000) )->REG_0F |= ((uint32_t)0x00000010);
	}
	else{
		((MDR_BKP_TypeDef *)(0x400D8000) )->REG_0F &= ~((uint32_t)0x00000010);
	}
...
void BKP_RTC_Reset ( FunctionalState NewState )
{
	...
	if(NewState != DISABLE){
		((MDR_BKP_TypeDef *)(0x400D8000) )->REG_0F |= ((uint32_t)0x80000000);
	}
	else{
		((MDR_BKP_TypeDef *)(0x400D8000) )->REG_0F &= ~((uint32_t)0x80000000);
	}
...
void BKP_RTC_WaitForUpdate ( void )
{
	...
	while((((MDR_BKP_TypeDef *)(0x400D8000) )->RTC_CS & ((uint32_t)0x00000040)) == ((uint32_t)0x00000040));
