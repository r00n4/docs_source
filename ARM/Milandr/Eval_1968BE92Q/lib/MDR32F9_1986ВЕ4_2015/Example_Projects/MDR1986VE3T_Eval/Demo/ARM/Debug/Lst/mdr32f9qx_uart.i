						   ...
						   UART_InitTypeDef* UART_InitStruct )
{
	...
	if(( UARTx == ((MDR_UART_TypeDef *)(0x40120000) ) ) || (UARTx == ((MDR_UART_TypeDef *)(0x40128000) )))
		tmpreg = ((MDR_RST_CLK_TypeDef *)(0x40020000) )->UART_SSP_CLOCK;
	else
		if(( UARTx == ((MDR_UART_TypeDef *)(0x40030000) ) ) || (UARTx == ((MDR_UART_TypeDef *)(0x40038000) )))
	...
	if (UARTx == ((MDR_UART_TypeDef *)(0x40030000) )) {
		...
		if (UARTx == ((MDR_UART_TypeDef *)(0x40038000) )) {
			...
			if(UARTx == ((MDR_UART_TypeDef *)(0x40120000) )) {
				cpuclock /= (1 << (tmpreg & ((uint32_t)0x0007) ));
			}
			else
				if(UARTx == ((MDR_UART_TypeDef *)(0x40128000) )) {
					cpuclock /= (1 << ((tmpreg & ((uint32_t)0x0700)) >> ((uint32_t)0x0008)));
				}
