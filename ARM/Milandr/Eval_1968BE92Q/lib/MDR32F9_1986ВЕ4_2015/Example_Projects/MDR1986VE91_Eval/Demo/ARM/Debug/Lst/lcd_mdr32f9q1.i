...
void ResetLCD(void)
{
  PORT_SetBits(((MDR_PORT_TypeDef *) (0x400B8000)), 0x0200U);
  PORT_ResetBits(((MDR_PORT_TypeDef *) (0x400B8000)), 0x0200U);
  Pause();
  PORT_SetBits(((MDR_PORT_TypeDef *) (0x400B8000)), 0x0200U);
...
void SetCrystal(LCD_Crystal num)
{
  PORT_Write(((MDR_PORT_TypeDef *) (0x400C8000)), ((num + 1) << 4));
