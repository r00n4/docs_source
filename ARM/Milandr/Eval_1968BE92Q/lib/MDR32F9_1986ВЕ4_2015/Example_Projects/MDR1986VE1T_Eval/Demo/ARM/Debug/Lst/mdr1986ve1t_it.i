...
#line 25 "..\\..\\src\\MDR1986VE1T_it.c"
#line 1 "..\\..\\Inc\\MDR1986VE1T_it.h"
  ...
  if (BKP_RTC_GetFlagStatus(((uint32_t)((uint32_t)0x00000004))) == SET)
  {
    if (STOPModeStatus)
    {
      ...
      if (AlarmSetStatus)
      {
        for (i = 0; i < 5; i++)
        {
          PORT_SetBits(((MDR_PORT_TypeDef *)(0x400C0000) ), (0x0080U | 0x0100U | 0x0200U | 0x0400U | 0x0800U | 0x1000U | 0x2000U | 0x4000U));
          for (j = 0; j < 300000; j++)
          {
          }
