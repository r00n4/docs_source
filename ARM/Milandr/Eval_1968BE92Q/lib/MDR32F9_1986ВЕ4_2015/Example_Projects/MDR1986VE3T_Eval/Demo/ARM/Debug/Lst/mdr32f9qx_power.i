...
#line 34 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"
...
#line 66 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"

#line 75 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"
...
#line 89 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"

#line 98 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"
...
#line 115 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"

#line 124 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_power.h"
...
#line 66 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_power.c"
...
void POWER_DUccTrim(uint32_t DUccTrim)
{
  ...
  tmpreg  = ((MDR_BKP_TypeDef *)(0x400D8000) ) -> REG_0E & (uint32_t) (~((uint32_t)((uint32_t)0x00003700)));
   
  tmpreg |= ((uint32_t)((uint32_t)0x00003700)) & DUccTrim;
  ((MDR_BKP_TypeDef *)(0x400D8000) ) -> REG_0E = tmpreg;
}
...
void POWER_SetFlagPOR ( void )
{
	...
	((MDR_BKP_TypeDef *)(0x400D8000) )->REG_0E |= ((uint32_t)0x00000800);
...
#line 258 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_power.c"
  if (( ((MDR_BKP_TypeDef *)(0x400D8000) )->REG_0E & ((uint32_t)0x00000800) ) == ((uint32_t)0x00000800)) {
	  state = SUCCESS;
  }
...
void POWER_PVDenable ( FunctionalState NewState )
{
	...
	if(NewState != DISABLE){
		((MDR_POWER_TypeDef *)(0x40058000) )->PVDCS |= ((uint32_t)0x00000001);
	}
	else {
		((MDR_POWER_TypeDef *)(0x40058000) )->PVDCS &= ~((uint32_t)0x00000001);
	}
...
#line 426 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_power.c"
...
void POWER_EnterSLEEPMode(void)
{
	...
	((MDR_RST_CLK_TypeDef *)(0x40020000) )->ETH_CLOCK |= 1 << 26;
}
...
void POWER_SetTrim(uint32_t trim)
{
	...
	tmpreg = ((MDR_BKP_TypeDef *)(0x400D8000) )->REG_0E & (~(3 << 12));
	tmpreg = tmpreg | trim;
	((MDR_BKP_TypeDef *)(0x400D8000) )->REG_0E = tmpreg;
}
