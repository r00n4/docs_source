...
const LCD_Ports CrystalPorts[NUM_LCD_CRYSTALS] = {
  ...
  { 0x60000000 + 0x8000000 + 0x4000000,
    0x60000000 + 0x8000000 },
   
  { 0x60000000 + 0x10000000 + 0x4000000,
...
void ResetLCD(void)
{
  PORT_SetBits(((MDR_PORT_TypeDef *)(0x400E8000) ), 0x0001U);
  PORT_ResetBits(((MDR_PORT_TypeDef *)(0x400E8000) ), 0x0001U);
  Pause();
  PORT_SetBits(((MDR_PORT_TypeDef *)(0x400E8000) ), 0x0001U);
...
void SetCrystal(LCD_Crystal num)
{
  PORT_Write(((MDR_PORT_TypeDef *)(0x400C8000) ), ((num + 1) << 13));
