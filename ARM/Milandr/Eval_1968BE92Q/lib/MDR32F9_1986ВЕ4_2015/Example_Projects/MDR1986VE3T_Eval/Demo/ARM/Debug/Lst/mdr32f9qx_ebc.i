...
void EBC_StructInit(EBC_InitTypeDef* EBC_InitStruct)
{
  ...
  EBC_InitStruct->EBC_DataAlignment = ((uint32_t)0x0);
...
void EBC_MemRegionStructInit (EBC_MemRegionInitTypeDef * EBC_MemRegionInitStruct)
{
	...
	EBC_MemRegionInitStruct->WS_Setup 		= ((uint32_t)0x00);
	EBC_MemRegionInitStruct->WS_Hold 		= ((uint32_t)0x00);
...
void EBC_MemRegionInit ( EBC_MemRegionInitTypeDef * EBC_MemRegionInitStruct, uint32_t EBC_MEM_REGIONx )
{
	...
	tmpreg_Mem_Region = (EBC_MemRegionInitStruct->Use_Ready << 14)
    		          | (EBC_MemRegionInitStruct->WS_Hold << 11)
    		          | (EBC_MemRegionInitStruct->WS_Setup << 8)
					  | (EBC_MemRegionInitStruct->WS_Active << 1)
					  | (EBC_MemRegionInitStruct->Enable_Tune << 0);

	EBCx = (MDR_EBC_TypeDef *)((MDR_EBC_TypeDef *)(0x400F0000) );
...
void EBC_MemRegionCMD ( uint32_t EBC_MEM_REGIONx, uint32_t NewState )
{
	MDR_EBC_TypeDef *EBCx = (MDR_EBC_TypeDef *)((MDR_EBC_TypeDef *)(0x400F0000) );
	...
	if(NewState != DISABLE){
		...
		EBCx->MEM_REGION[EBC_MEM_REGIONx] |= ((uint32_t)0x00000001);
	}
	else{
