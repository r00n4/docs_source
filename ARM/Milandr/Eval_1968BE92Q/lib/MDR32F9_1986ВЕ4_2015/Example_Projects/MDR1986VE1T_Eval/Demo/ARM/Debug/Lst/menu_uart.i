...
void UARTwFIFOFunc(void) {
  ...
  UART_DMAConfig (((MDR_UART_TypeDef *)(0x40030000) ), ((14) == 2 ? ((uint32_t)0x00000000) : (14) == 4 ? ((uint32_t)0x00000001) : (14) == 8 ? ((uint32_t)0x00000002) : (14) == 12 ? ((uint32_t)0x00000003) : (14) == 14 ? ((uint32_t)0x00000004) : 0xFFFF),
