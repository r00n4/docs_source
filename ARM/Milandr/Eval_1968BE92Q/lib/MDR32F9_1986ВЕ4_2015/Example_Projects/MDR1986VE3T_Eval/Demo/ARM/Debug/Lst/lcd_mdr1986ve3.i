...
void ResetLCD(void)
{
  PORT_SetBits(((MDR_PORT_TypeDef *)(0x400C0000) ), 0x1000U);
  PORT_ResetBits(((MDR_PORT_TypeDef *)(0x400C0000) ), 0x1000U);
  Pause();
  PORT_SetBits(((MDR_PORT_TypeDef *)(0x400C0000) ), 0x1000U);
