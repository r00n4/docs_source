...
void RST_CLK_HSE2config(uint32_t RST_CLK_HSE2)
{
  ...
  ((MDR_RST_CLK_TypeDef *)(0x40020000) )->HS_CONTROL &= ~((uint32_t)(((uint32_t)0x00000004) | ((uint32_t)0x00000008)));
   
  switch (RST_CLK_HSE2)
  {
    case ((uint32_t)0x00000004):
       
      ((MDR_RST_CLK_TypeDef *)(0x40020000) )->HS_CONTROL |= ((uint32_t)0x00000004);
      break;

    case ((uint32_t)0x00000008):
       
      ((MDR_RST_CLK_TypeDef *)(0x40020000) )->HS_CONTROL |= ((uint32_t)0x00000004) | ((uint32_t)0x00000008);
      break;
...
ErrorStatus RST_CLK_HSE2status(void)
{
  ...
  do{
    flag = RST_CLK_GetFlagStatus(((uint32_t)(0x20 | 3)));
    startCounter++;
  } while ((startCounter < ((uint16_t)0x8000)) && (flag == RESET));

  if (RST_CLK_GetFlagStatus(((uint32_t)(0x20 | 3))) != RESET)
  {
    state = SUCCESS;
  }
  else
...
#line 636 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_rst_clk.c"
  if( (((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL & ((uint32_t)0x00000004)) == ((uint32_t)0x00000004) ) {
    temp = ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL;
    temp |= ((uint32_t)0x00000008);
    ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL = temp;
    temp &= ~((uint32_t)0x00000008);
    ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL = temp;
  }
...
#line 854 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_rst_clk.c"


  if( ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL & (((uint32_t)0x00000001)) ) {
    temp = ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL;
    temp |= ((uint32_t)0x00000002);
    ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL = temp;
    temp &= ~((uint32_t)0x00000002);
    ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL = temp;
  }
...
void RST_CLK_AUCclkDeInit(void)
{
  ...
  ((MDR_RST_CLK_TypeDef *)(0x40020000) )->ADC_MCO_CLOCK &= ~(((uint32_t)0x00030000) |
                              ((uint32_t)0x00300000) |
                              ((uint32_t)0x0F000000) |
                              ((uint32_t)0x80000000));
...
void RST_CLK_PCLK2cmd ( uint32_t RST_CLK_PCLK2, FunctionalState NewState ) {
  ...
  if(NewState != DISABLE){
    ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PER2_CLOCK |= RST_CLK_PCLK2;
  }
  else{
    ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PER2_CLOCK &= ~RST_CLK_PCLK2;
  }
