...
#line 30 "..\\..\\inc\\lcd_MDR32F9Q1.h"
#line 31 "..\\..\\inc\\lcd_MDR32F9Q1.h"
#line 32 "..\\..\\inc\\lcd_MDR32F9Q1.h"
#line 33 "..\\..\\inc\\lcd_MDR32F9Q1.h"
#line 1 "..\\..\\inc\\lcd.h"
...
USB_Result USB_CDC_SetLineCoding(uint16_t wINDEX, const USB_CDC_LineCoding_TypeDef* DATA)
{
  ...
  UART_ITConfig (((MDR_UART_TypeDef *) (0x40038000)), ((uint32_t)0x00000020) | ((uint32_t)0x00000010)
...
static void UARTConfiguration(void)
{
  ...
  UART_BRGInit(((MDR_UART_TypeDef *) (0x40038000)), ((uint32_t)0x00000004));
...
static void SenderFunc(void)
{
  for (; (send_data_pos < send_data_length && (UART_GetFlagStatus (((MDR_UART_TypeDef *) (0x40038000)), ((uint32_t)0x00000020)) == RESET)); send_data_pos++)
  {
    UART_SendData(((MDR_UART_TypeDef *) (0x40038000)), SendBuffer[send_data_pos]);
  }
}
...
static void ReceiverFunc(void)
{
  ...
  for (receive_data_length = 0; ((UART_GetFlagStatus(((MDR_UART_TypeDef *) (0x40038000)), ((uint32_t)0x00000010)) == RESET) && (receive_data_length < 100)); )
  {
