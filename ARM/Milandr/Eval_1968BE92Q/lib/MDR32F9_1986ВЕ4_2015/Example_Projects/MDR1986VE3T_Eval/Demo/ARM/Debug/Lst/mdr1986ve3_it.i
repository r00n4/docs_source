  ...
  if (BKP_RTC_GetFlagStatus(((uint32_t)((uint32_t)0x00000004))) == SET)
  {
    if (STOPModeStatus)
    {
      ...
      if (AlarmSetStatus)
      {
        for (i = 0; i < 5; i++)
        {
          PORT_SetBits(((MDR_PORT_TypeDef *)(0x400B0000) ), (0x0002U | 0x0004U | 0x0008U | 0x0010U | 0x0020U | 0x0040U | 0x0080U | 0x0001U));
          for (j = 0; j < 300000; j++)
          {
          }
