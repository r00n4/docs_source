...
void Init_All_Ports(void)
{
  ...
  RST_CLK_PCLKcmd((((uint32_t)(1 << ((((uint32_t)(0x400A8000)) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)(0x400B0000)) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)(0x400B8000)) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)(0x400C0000)) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)(0x400C8000)) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)(0x400E8000)) >> 15) & 0x1F)))), DISABLE);
}
...
uint32_t tmp_port_pin;
  ...
  RST_CLK_PCLKcmd(((uint32_t)(1 << ((((uint32_t)(0x400B8000)) >> 15) & 0x1F))) | ((uint32_t)(1 << ((((uint32_t)(0x400C0000)) >> 15) & 0x1F))), ENABLE);

   

  PORT_InitStructure.PORT_Pin   = (0x0400U | 0x0800U | 0x1000U |
                                   0x2000U | 0x4000U);
  ...
  for (tmp_port_pin = 0x0400U; ;
       tmp_port_pin = (tmp_port_pin >= 0x4000U ? 0x0400U : (tmp_port_pin << 1)))
  {
    if (PORT_ReadInputDataBit(((MDR_PORT_TypeDef *) (0x400B8000)), tmp_port_pin) == Bit_RESET)
    {
      PORT_SetBits(((MDR_PORT_TypeDef *) (0x400C0000)), tmp_port_pin);
    }
    else
    {
      PORT_ResetBits(((MDR_PORT_TypeDef *) (0x400C0000)), tmp_port_pin);
    }
  }
}
