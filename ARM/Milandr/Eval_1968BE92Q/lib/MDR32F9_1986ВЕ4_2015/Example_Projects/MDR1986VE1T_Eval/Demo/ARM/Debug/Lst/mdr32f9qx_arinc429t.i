#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_arinc429t.c"
...
#line 26 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_arinc429t.c"
#line 1 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_arinc429t.h"
...
#line 35 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\inc\\MDR32F9Qx_arinc429t.h"
...
typedef struct {
	uint32_t 		ARINC429T_ODD;			
 
	FunctionalState ARINC429T_EN_PAR;		
 
	uint32_t 		ARINC429T_CLK;			
 
	uint32_t 		ARINC429T_DIV;			
...
#line 27 "..\\..\\..\\..\\Libraries\\MDR32F9Qx_StdPeriph_Driver\\src\\MDR32F9Qx_arinc429t.c"
...
void ARINC429T_BRG_Init(uint32_t ARINC429T_BRG)
{
	...
	ARINC429Tx = ((MDR_ARINC429T_TypeDef *)(0x400E0000) );

	tmpreg_CONTROL1 = ARINC429Tx->CONTROL1;
	tmpreg_CONTROL1 &= ~((uint32_t)0x00007F00);
	tmpreg_CONTROL1 |= (ARINC429T_BRG << 8);
...
void ARINC429T_ChannelInit(uint32_t ARINC429T_CHANNELx, ARINC429T_InitChannelTypeDef * ARINC429T_InitChanelStruct)
{
	...
	switch(ARINC429T_CHANNELx){
		...
		case ((uint32_t)0x00000001):
			tmpreg_CONTROL1 = ARINC429Tx->CONTROL1;
			tmpreg_CONTROL1 &= ~( (1 << (1 + ARINC429T_CHANNELx*4))							     |(1 << (2 + ARINC429T_CHANNELx*4))							     |(1 << (3 + ARINC429T_CHANNELx*4)));


			tmpreg_CONTROL1 |= ((ARINC429T_InitChanelStruct->ARINC429T_CLK << (1 + ARINC429T_CHANNELx*4))							     |(ARINC429T_InitChanelStruct->ARINC429T_EN_PAR << (2 + ARINC429T_CHANNELx*4))							     |(ARINC429T_InitChanelStruct->ARINC429T_ODD << (3 + ARINC429T_CHANNELx*4)));
		...
		case ((uint32_t)0x00000003):
			...
			tmpreg_CONTROL2 &= ~( (1 << (1 + (ARINC429T_CHANNELx - ((uint32_t)0x00000002))*4))							     |(1 << (2 + (ARINC429T_CHANNELx - ((uint32_t)0x00000002))*4))							     |(1 << (3 + (ARINC429T_CHANNELx - ((uint32_t)0x00000002))*4)));


			tmpreg_CONTROL2 |= ((ARINC429T_InitChanelStruct->ARINC429T_CLK << (1 + (ARINC429T_CHANNELx - ((uint32_t)0x00000002))*4))							     |(ARINC429T_InitChanelStruct->ARINC429T_EN_PAR << (2 + (ARINC429T_CHANNELx - ((uint32_t)0x00000002))*4))							     |(ARINC429T_InitChanelStruct->ARINC429T_ODD << (3 + (ARINC429T_CHANNELx - ((uint32_t)0x00000002))*4)));
...
void ARINC429T_ChannelCmd(uint32_t ARINC429T_CHANNELx, FunctionalState NewState)
{
	...
	if(NewState != DISABLE){
		if(ARINC429T_CHANNELx <= ((uint32_t)0x00000001))
			ARINC429Tx->CONTROL1 |= 1 << (0 + ARINC429T_CHANNELx*4);
		else
			ARINC429Tx->CONTROL2 |= 1 << (0 +(ARINC429T_CHANNELx - ((uint32_t)0x00000002))*4);
	}
	else{
		if(ARINC429T_CHANNELx <= ((uint32_t)0x00000001))
			ARINC429Tx->CONTROL1 &= ~(1 << (0 + ARINC429T_CHANNELx*4));
...
void ARINC429T_ITConfig(uint32_t ARINC429T_CHANNELx, uint32_t ARINC429T_IT, FunctionalState NewState)
{
	...
	if(NewState != DISABLE){
		if(ARINC429T_CHANNELx < ((uint32_t)0x00000002))
			ARINC429Tx->CONTROL1 |= ARINC429T_IT << (15 + (ARINC429T_CHANNELx * 3));
		else
			ARINC429Tx->CONTROL2 |= ARINC429T_IT << (15 + ((ARINC429T_CHANNELx - ((uint32_t)0x00000002)) * 3));
	}else{
		if(ARINC429T_CHANNELx < ((uint32_t)0x00000002))
			ARINC429Tx->CONTROL1 &= ~(ARINC429T_IT << (15 + (ARINC429T_CHANNELx * 3)));
		else
...
FlagStatus ARINC429T_GetFlagStatus(uint32_t ARINC429T_CHANNELx, uint32_t ARINC429T_FLAG)
{
	...
	switch(ARINC429T_FLAG){
		case ((uint32_t)0x00000001):
			bitstatus = (ARINC429Tx->STATUS & (1 << (0 + ARINC429T_CHANNELx *3 + 2*(ARINC429T_CHANNELx >= ((uint32_t)0x00000002))))) == 0 ? RESET : SET;
			break;
		case ((uint32_t)0x00000002):
			bitstatus = (ARINC429Tx->STATUS & (1 << (1 + ARINC429T_CHANNELx *3 + 2*(ARINC429T_CHANNELx >= ((uint32_t)0x00000002))))) == 0 ? RESET : SET;
			break;
		case ((uint32_t)0x00000004):
			bitstatus = (ARINC429Tx->STATUS & (1 << (2 + ARINC429T_CHANNELx *3 + 2*(ARINC429T_CHANNELx >= ((uint32_t)0x00000002))))) == 0 ? RESET : SET;
			break;
	}
	return (bitstatus);
}
